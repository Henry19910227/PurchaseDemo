...
class PDStoreViewController: UIViewController {
    ...
    lazy var request: SKProductsRequest = {
        return SKProductsRequest(productIdentifiers: ["com.fitness.copper_course", "com.fitness.silver_course", "com.fitness.gold_member_month", "com.fitness.gold_member_year"])
    }()
